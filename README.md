[![Run App Thomas Vierk](https://github.com/ThomasVierk/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/ThomasVierk/GithubActions/actions/workflows/run-app.yaml)
